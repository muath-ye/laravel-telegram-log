...
namespace YemeniOpenSource\TelegramLog\Exceptions;
...
class TelegramHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(array $config)
    {
        ...
        $this->appName = config('app.name', 'UNKNOWN-APP-NAME');
        $this->appEnv = config('app.env', 'UNKNOWN-APP-ENV');
    }
    ...
    private function getConfigValue($key, $defaultConfigKey = null): string
    {
        ...
        return config($defaultConfigKey ?: "telegramlog.$key");
    }
}
